...
public class Peminjaman1841720070yayak {
    private int idpeminjaman;
    private Anggota1841720070yayak anggota = new Anggota1841720070yayak();
    private Buku1841720070yayak buku = new Buku1841720070yayak();
    private String tanggalpinjam;
    private String tanggalkembali;

    public Peminjaman1841720070yayak() {
    }

    public Peminjaman1841720070yayak(Anggota1841720070yayak anggota, Buku1841720070yayak buku, String tanggalpinjam, String tanggalkembali) {        
    ...
    public Anggota1841720070yayak getAnggota() {
        return anggota;
    }

    public void setAnggota(Anggota1841720070yayak anggota) {
        this.anggota = anggota;
    }

    public Buku1841720070yayak getBuku() {
        return buku;
    }

    public void setBuku(Buku1841720070yayak buku) {
        this.buku = buku;
    }
    ...
    public Peminjaman1841720070yayak getById(int id){
        Peminjaman1841720070yayak peminjaman = new Peminjaman1841720070yayak();
        ...
        try {
            while(rs.next()){
                peminjaman = new Peminjaman1841720070yayak();
    ...
    public ArrayList<Peminjaman1841720070yayak> getAll(){
        ArrayList<Peminjaman1841720070yayak> ListPeminjaman = new ArrayList();
        ResultSet rs = DBHelper1841720070yayak.selectQuery("SELECT "
                                        +"      p.idpeminjaman AS idpeminjaman, "
                                        +"      p.tanggalpinjam AS tanggalpinjam, "
                                        +"      p.tanggalkembali AS tanggalkembali, "
    ...
    public ArrayList<Peminjaman1841720070yayak> search(String keyword){
        ArrayList<Peminjaman1841720070yayak> ListPeminjaman = new ArrayList();
        ResultSet rs = DBHelper1841720070yayak.selectQuery("SELECT "
                                        +"      p.idpeminjaman AS idpeminjaman, "
                                        +"      p.tanggalpinjam AS tanggalpinjam, "
    ...
    public void save(){
        if(getById(idpeminjaman).getIdpeminjaman()== 0){
            String SQL = "INSERT INTO peminjaman (idanggota, idbuku, tanggalpinjam, tanggalkembali) VALUES("
                    ...
                    +"      '"+ this.tanggalkembali + "' "
                    +"      )";
            this.idpeminjaman = DBHelper1841720070yayak.insertQueryGetId(SQL);
