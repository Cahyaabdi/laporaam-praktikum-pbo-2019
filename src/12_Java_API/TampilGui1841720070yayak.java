...
public class TampilGui1841720070yayak extends javax.swing.JFrame {
    DefaultTableModel TabMahasiswa;
    InputData1841720070yayak DataMahasiswa;
    /**
     * Creates new form TampilGui
     */
    public TampilGui1841720070yayak() {
        initComponents();
        DataMahasiswa = new InputData1841720070yayak();
        LihatDataMahasiswa();
    }
    public final void LihatDataMahasiswa(){
        ...
        int i = 0;
        for (Mahasiswa1841720070yayak mhs: DataMahasiswa.getData()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TampilGui1841720070yayak.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TampilGui1841720070yayak().setVisible(true);
            }
        });
    }
